package com.vianstats.media.convert.utils.other;

import com.vianstats.media.convert.utils.other.domain.ImageMetaInfo;
import com.vianstats.media.convert.utils.other.domain.MusicMetaInfo;
import com.vianstats.media.convert.utils.other.domain.VideoMetaInfo;
import com.vianstats.media.convert.utils.other.gif.AnimatedGifEncoder;
 ...
 *
 */
public class OtherMediaUtil {

    private static final Logger log = LoggerFactory.getLogger(OtherMediaUtil.class);

    /**
     * 可以处理的视频格式
     */
	public final static String[] VIDEO_TYPE = { "MP4", "WMV" ,"MKV"};
    /**
     * 可以处理的图片格式
     */
